...
if (!hasGoogleCredentials) {
        log.warn(
                "CREDENTIALS",
                `Google credentials not configured in ${path.normalize(global.client.dirConfig)}, Drive features disabled`,
        );
}

const oauth2ClientForGGDrive = hasGoogleCredentials
...
const driveApi = hasGoogleCredentials
        ? google.drive({
                version: "v3",
